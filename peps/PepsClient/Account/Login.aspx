<%@ Page Title="Se connecter" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="Login.aspx.cs" Inherits="PepsClient.Account.Login" %>
    ...
    <asp:Login ID="LoginUser" runat="server" EnableViewState="false" RenderOuterTable="false">
        <LayoutTemplate>
            ...
            <div class="accountInfo">
                ...
                <p><asp:HyperLink ID="RegisterHyperLink" runat="server" EnableViewState="false">S'inscrire</asp:HyperLink> si vous n'avez pas de compte.</p>
</asp:Content>
